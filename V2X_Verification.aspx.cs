    ...
    public partial class V2X_Verification : System.Web.UI.Page
    {
        ...
        protected void VisualizeButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                removeClasses(home, new List<string> { "show", "active" });
                removeClasses(home_tab, new List<string> { "active" });
                addClasses(profile, new List<string> { "show", "active" });
                addClasses(profile_tab, new List<string> { "active" });
            }
